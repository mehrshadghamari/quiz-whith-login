...
from quiz import show_users_quiz
    ...
    while True:
        try:
            ...
            if user_command == '0':
                ...
                while True:
                    colored_print('Enter "info" for your full account information; "list" for user list , "quiz" for your quiz; ( info/list/quiz ): ', 'message', br=False)
                    whats_next = input()
